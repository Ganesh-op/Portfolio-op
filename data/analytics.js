  ...
  projects: [
    {
      ...
      description:
        "An end-to-end pipeline ingesting 100k+ tweets daily, performing NLP-based sentiment scoring, and rendering interactive Tableau dashboards. Features time-series correlation analysis between sentiment shifts and stock price movements.",
    ...
    },
    {
      ...
      description:
        "The original dataset had more than 80K records which needed to be cleaned first and processed for this portfolio project and only the cleaned dataset of 76K records is present in repository.",
  ...
  experience: [
    {
      ...
      brief:
        "Providing end-to-end data analysis, dashboard development, and business intelligence solutions for startups, students, and small businesses.",
      details: [
